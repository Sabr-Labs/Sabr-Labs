        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed max-w-xs">
              Two engineers creating software that eases
              everyday life. Built from personal experience,
              shared for everyone.
            </p>
            <div className="flex gap-3 mt-6">
              <a href="#" className="w-9 h-9 rounded-full bg-gray-800 dark:bg-gray-900 flex items-center justify-center hover:bg-gray-700 dark:hover:bg-gray-800 transition-colors" aria-label="LinkedIn">
              ...
              <a href="#" className="w-9 h-9 rounded-full bg-gray-800 dark:bg-gray-900 flex items-center justify-center hover:bg-gray-700 dark:hover:bg-gray-800 transition-colors" aria-label="GitHub">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-gray-300">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm mb-4">
              Get notified when we launch new projects and features.
            </p>
            <form className="flex" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
                placeholder="Your email address"
                className="flex-1 bg-gray-800 dark:bg-gray-900 border border-gray-700 dark:border-gray-800 rounded-l-lg px-4 py-2.5 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-brand-blue"
              />
              <button
                type="submit"
      ...
      <div className="border-t border-gray-800 dark:border-gray-900">
        <div className="container mx-auto px-6 py-5 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-xs">
            &copy; {currentYear} Sabr Labs. All rights reserved.
          </p>
          <div className="flex gap-6">
            <a href="#" className="text-gray-400 text-xs hover:text-gray-300 transition-colors">Privacy Policy</a>
